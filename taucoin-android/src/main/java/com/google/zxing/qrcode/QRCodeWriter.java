...
public final class QRCodeWriter {
  ...
  public Bitmap encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType, ?> hints, Bitmap logoBitmap, Context context)
          throws WriterException {
      return encode(contents, format, width, height, hints, null, logoBitmap, context);
  }

  public Bitmap encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType, ?> hints,
                       Bitmap bitmap, Bitmap logoBitmap, Context context) throws WriterException {
    ...
    // 加载logo
    if (logoBitmap != null) {
      Drawable drawable = new BitmapDrawable(context.getResources(), logoBitmap).mutate();
