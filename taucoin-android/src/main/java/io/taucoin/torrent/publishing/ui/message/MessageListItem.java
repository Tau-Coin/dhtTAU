...
public class MessageListItem extends VideoInfo
{
    public MessageListItem(@NonNull VideoInfo state) {
    ...
    public boolean equalsContent(MessageListItem item)
    {
    ...
    {
        if (!(o instanceof MessageListItem))
            return false;

        if (o == this)
            return true;

        return videoId.equals(((MessageListItem)o).videoId);
    }
}
