...
public class TxListItem extends VideoInfo
{
    public TxListItem(@NonNull VideoInfo state) {
    ...
    public boolean equalsContent(TxListItem item)
    {
    ...
    {
        if (!(o instanceof TxListItem))
            return false;

        if (o == this)
            return true;

        return videoId.equals(((TxListItem)o).videoId);
    }
}
