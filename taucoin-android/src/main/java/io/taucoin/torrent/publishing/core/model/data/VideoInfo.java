...
public class VideoInfo extends AbstractInfoParcel
{
    @NonNull
...
//    public Priority[] filePriorities = new Priority[0];
    ...
    public VideoInfo(@NonNull String videoId, String name, long dateAdded, String error)
    {
        super(videoId);
...
//        this.stateCode = TorrentStateCode.STOPPED;
    ...
    public VideoInfo(@NonNull String videoId, String name,
...
//        this.filePriorities = filePriorities;
    ...
    public VideoInfo(Parcel source)
    {
        super(source);
...
//        dest.writeArray(filePriorities);
    ...
    {
        return name.compareTo(((VideoInfo)another).name);
    }
...
//        result = Arrays.hashCode(filePriorities);
    ...
    public boolean equals(Object o)
    {
        ...
        return (videoId.equals(info.videoId) &&
