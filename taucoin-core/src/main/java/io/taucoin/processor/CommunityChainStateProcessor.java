...
public class CommunityChainStateProcessor implements StateProcessor {

    private static final Logger logger = LoggerFactory.getLogger("CommunityChainStateProcessor");
