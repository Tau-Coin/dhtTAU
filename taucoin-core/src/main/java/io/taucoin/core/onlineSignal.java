...
public class onlineSignal {
    ...
    public onlineSignal(Bloom messageBloomFilter, byte[] bloomReceiptHash, byte[] chattingFriend,
    ...
    public onlineSignal(Bloom messageBloomFilter, byte[] bloomReceiptHash, Bloom friendListBloomFilter,
