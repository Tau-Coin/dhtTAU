...
public class NewMessage {
    ...
    public static NewMessage CreateTextMessage(BigInteger timestamp, BigInteger nonce, byte[] content) {
        return new NewMessage(MessageVersion.VERSION1, timestamp, nonce, MessageType.TEXT, content);
    }

    public static NewMessage CreatePictureMessage(BigInteger timestamp, BigInteger nonce, byte[] content) {
        return new NewMessage(MessageVersion.VERSION1, timestamp, nonce, MessageType.PICTURE, content);
    }

    public NewMessage(MessageVersion version, BigInteger timestamp, BigInteger nonce, MessageType type, byte[] content) {
